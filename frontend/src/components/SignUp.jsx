              ...
              <Col>
                ...
                <div className="manage">
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Control name="username" type="text" placeholder="Enter your Name" value={formData.username} onChange={handleChange} />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="ControlInput2">
                    <Form.Label>Email address</Form.Label>
                    <Form.Control name="email" type="email" placeholder="Enter your email" value={formData.email} onChange={handleChange}/>
                    </Form.Group>
